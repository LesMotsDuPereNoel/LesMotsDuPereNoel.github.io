...
//Le nombre d'indices disponibles dépend de la difficulté (1 pour 7 lettres).
const LONGUEUR_MOT = 7;
const MAX_INDICES = 1;
...
function donnerIndice() {
    ...
    let motReponse = localStorage.getItem("mot7").toUpperCase();
...
function verifieMotEntre(ligne, longueur) {
    ...
    //Empêche la soumission si une case est vide
...
function afficherPopup(partieGagnee) {
    ...
    if (partieGagnee) {
        ...
        motSecret.textContent = "Le mot était : " + localStorage.getItem("mot7").toUpperCase();
    }
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Choisit un nouveau mot secret de 7 lettres à chaque chargement de la page
    choix7();
    document.getElementById("demo").innerHTML = localStorage.getItem("mot7");
