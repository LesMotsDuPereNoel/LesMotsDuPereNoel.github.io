...
//Le nombre d'indices disponibles dépend de la difficulté (2 pour 6 lettres).
...
function donnerIndice() {
    ...
    let motReponse = localStorage.getItem("mot6").toUpperCase();
...
function afficherPopup(partieGagnee) {
    ...
    if (partieGagnee) {
        ...
        motSecret.textContent = "Le mot était : " + localStorage.getItem("mot6").toUpperCase();
    }
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Choisit un nouveau mot secret de 6 lettres à chaque chargement de la page
    choix6();
    document.getElementById("demo").innerHTML = localStorage.getItem("mot6");
